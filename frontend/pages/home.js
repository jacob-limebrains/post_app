            ...
            <Container sx={{minWidth: '100vw', minHeight: '100vh'}}>
                ...
                <Box sx={{flexGrow: 1, mt: 9, p: 2}}>
                    ...
                    <Grid>
                        <Typography variant='h6' sx={{mt: 2, ml: 5}}>
                            It's out first social media website and not the only one in the world. We're not the best!!!
                            We
                ...
                <Box id='about' sx={{flexGrow: 1, backgroundColor: 'secondary.dark', borderRadius: '10px', p: 2}}>
                    <Grid>
                        ...
                        <Box>
                            <Typography variant='h6' sx={{ml: 2}}>
                                <div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis corporis cum
                                    eius
                                    nobis, quae quod. Cumque eaque enim, esse inventore nesciunt officiis perferendis
                                    quidem
                                ...
                                <div>Aliquid, animi at, commodi culpa cum debitis deleniti dignissimos dolorum error
                                    facere
                                    fugiat id illo impedit in numquam pariatur perferendis praesentium provident
                                    quisquam
                                    recusandae saepe sequi vero voluptas voluptatem voluptatibus.
                                </div>
                                <div>Accusamus ducimus earum, eligendi eveniet exercitationem facere facilis in nemo
                                    quasi
                                ...
                                <div>Beatae, eum excepturi ipsum natus neque omnis recusandae tenetur veniam. A aliquid
                                    aperiam, aut dicta eos eveniet explicabo fugiat ipsa minima praesentium provident
                                    quae
                                ...
                                <div>A ab corporis, debitis earum eius error, est eum fuga ipsum maiores nobis optio,
                                    perspiciatis placeat quos recusandae saepe tempora voluptatum! Ipsam laborum
                                    sapiente
                                ...
                                <div>Amet aspernatur atque blanditiis cupiditate deleniti dolorum eaque, earum excepturi
                                    fuga id illo in incidunt ipsum iure iusto labore laudantium minus natus nesciunt
                                    odio,
                                ...
                                <div>Distinctio, eius incidunt iste omnis provident qui quidem quo quod unde? Ad cumque,
                                    dolore, doloribus fugit illo itaque libero nobis numquam provident quae repellat
                                    rerum,
                                ...
                                <div>Autem dicta et eum nihil possimus qui sequi, similique sunt, tempora temporibus
                                    unde ut
